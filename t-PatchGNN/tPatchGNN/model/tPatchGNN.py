...
#	def forward(self, X, times, mask=None, truth_times=None):
#		"""
#		Entry point for model(X, times, …).
#		Routes into forecasting with full signature.
#		"""
#		truth = truth_times if truth_times is not None else times
#		return self.forecasting(times, X, truth, mask)
